      ...
      <div className="w-full h-full bg-gradient-to-r from-[#131424]/10 via-black/30 to-black/10">
        <div className="container grid items-center h-full px-5 md:grid-cols-2 md:text-left">
          ...
          >
            ...
            <p className="max-w-sm text-slate-400 text-justify mb-10 text-xl md:max-w-2xl md:mx-0 md:mb-16 md:text-xl">
              Lo más importante para hacer lo que piensas, es idear
              estratégicamente lo que tienes que hacer y dividirlo en tareas
              atomizadas.
            </p>
